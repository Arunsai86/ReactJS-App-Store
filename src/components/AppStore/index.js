...
class AppStore extends Component {
  ...
  getFilterApps = searchInput => {
    const {activeTabId} = this.state
    const filteredAppDetails = appsList.filter(
      eachApp => eachApp.category === activeTabId,
    )
    const resultData = filteredAppDetails.filter(eachApp =>
  ...
  render() {
    ...
    const filteredAppList = this.getFilterApps(searchInput)
      ...
      <div className="bg-container">
        ...
        <div className="input-container">
          <input
            type="search"
            placeholder="Search"
            onChange={this.clickSearchInput}
          />
